...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('back_end/img/apple-icon.png') }}">
  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="{{asset('back_end/img/faces/avatar.jpg') }}" />
          </div>
          <div class="user-info">
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/img/flags/US.png') }}" </div>
                                </td>
                                <td>USA</td>
                                <td class="text-right">
                                  2.920
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/assets/img/flags/DE.png') }}" </div>
                                </td>
                                <td>Germany</td>
                                <td class="text-right">
                                  1.300
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/img/flags/AU.png') }}" </div>
                                </td>
                                <td>Australia</td>
                                <td class="text-right">
                                  760
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/img/flags/GB.png') }}" </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/img/flags/RO.png') }}" </div>
                                </td>
                                <td>Romania</td>
                                <td class="text-right">
                                  600
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="{{asset('back_end/img/flags/BR.png') }}" </div>
                                </td>
                                <td>Brasil</td>
                                <td class="text-right">
                                  550
...
7 days
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="{{asset('back_end/img/card-2.jpg') }}">
                                </a>
                              </div>
                              <div class="card-body">
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="{{asset('back_end/img/card-3.jpg') }}">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="{{asset('back_end/img/card-1.jpg') }}">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active">
                      <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{asset('back_end/img/sidebar-1.jpg') }}" alt="">
                      </a>
                    </li>
                    <li>
                      <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{asset('back_end/img/sidebar-2.jpg') }}" alt="">
                      </a>
                    </li>
                    <li>
                      <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{asset('back_end/img/sidebar-3.jpg') }}" alt="">
                      </a>
                    </li>
                    <li>
                      <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{asset('back_end/img/sidebar-4.jpg') }}" alt="">
                      </a>
                    </li>
              ...
              <!--   Core JS Files   -->
              <script src="{{asset('back_end/js/core/jquery.min.js') }}"></script>
              <script src="{{asset('back_end/js/core/popper.min.js') }}"></script>
              <script src="{{asset('back_end/js/core/bootstrap-material-design.min.js') }}"></script>
              <script src="{{asset('back_end/js/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
              <!-- Plugin for the momentJs  -->
              <script src="{{asset('back_end/js/plugins/moment.min.js') }}"></script>
              <!--  Plugin for Sweet Alert -->
              <script src="{{asset('back_end/js/plugins/sweetalert2.js') }}"></script>
              <!-- Forms Validations Plugin -->
              <script src="{{asset('back_end/js/plugins/jquery.validate.min.js') }}"></script>
              <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
              <script src="{{asset('back_end/js/plugins/jquery.bootstrap-wizard.js') }}"></script>
              <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
              <script src="{{asset('back_end/js/plugins/bootstrap-selectpicker.js') }}"></script>
              <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
              <script src="{{asset('back_end/js/plugins/bootstrap-datetimepicker.min.js') }}"></script>
              <!--  DataTables.net Plugin, full documentation here: https://datatables.net/  -->
              <script src="{{asset('back_end/js/plugins/jquery.dataTables.min.js') }}"></script>
              <!--	Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
              <script src="{{asset('back_end/js/plugins/bootstrap-tagsinput.js') }}"></script>
              <!-- Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
              <script src="{{asset('back_end/js/plugins/jasny-bootstrap.min.js') }}"></script>
              <!--  Full Calendar Plugin, full documentation here: https://github.com/fullcalendar/fullcalendar    -->
              <script src="{{asset('back_end/js/plugins/fullcalendar.min.js') }}"></script>
              <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
              <script src="{{asset('back_end/js/plugins/jquery-jvectormap.js') }}"></script>
              <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
              <script src="{{asset('back_end/js/plugins/nouislider.min.js') }}"></script>
              <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
              <script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
              <!-- Library for adding dinamically elements -->
              <script src="{{asset('back_end/js/plugins/arrive.min.js') }}"></script>
              <!--  Google Maps Plugin    -->
              <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2Yno10-YTnLjjn_Vtk0V8cdcY5lC4plU"></script>
              <!-- Place this tag in your head or just before your close body tag. -->
              <script async defer src="https://buttons.github.io/buttons.js') }}"></script>
              <!-- Chartist JS -->
              <script src="{{asset('back_end/js/plugins/chartist.min.js') }}"></script>
              <!--  Notifications Plugin    -->
              <script src="{{asset('back_end/js/plugins/bootstrap-notify.js') }}"></script>
